...
export const HeroImage = ({ data, custom }: SectionProps<HeroImageData[]>) => {
  // Props
                ...
                {item.media_type == "image" && (
                  <div className="absolute bottom-0 left-0 right-0 max-w-[1440px] w-full mx-auto p-[max(32px,_min(calc(100vw_*_(100_/_1440)),_100px))_max(20px,_min(calc(100vw_*_(70_/_1440)),_70px))] max-md:pb-20 max-sm:pb-14 flex flex-col items-start gap-4 max-md:gap-3.5 max-sm:gap-3">
                    ...
                    <TextHuge
                      ...
                      cls="max-w-sm max-md:max-64 max-sm:max-w-64"
                    />
                    <TextMedium
                      label="Read More"
                      el="a"
...
const SampleNextArrow = (props: any) => {
  ...
  return (
    <div
      className="slick-next w-12 h-12 max-md:w-10 max-md:h-8 max-sm:w-8 max-sm:h-6"
      onClick={onClick}
    >
      <svg
...
const SamplePrevArrow = (props: any) => {
  ...
  return (
    <div
      className="slick-prev w-12 h-12 max-md:w-10 max-md:h-8 max-sm:w-8 max-sm:h-6"
      onClick={onClick}
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
