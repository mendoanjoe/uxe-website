...
import { SECTION_CEO } from "lib/constants";
...
export const CEOMessage = ({ data, custom }: SectionProps<CeoMessageData>) => {
      ...
      <div className="max-w-[1440px] mx-auto p-[max(48px,_min(calc(100vw_*_(100_/_1440)),_100px))_max(20px,_min(calc(100vw_*_(178_/_1440)),_178px))] max-xl:px-[max(20px,_min(calc(100vw_*_(70_/_1440)),_70px))] overflow-hidden">
        <div className="mx-auto">
          ...
          <TitleMedium
            el="h2"
            label="Leadership"
            cls="text-[#19191B] font-medium mb-10 max-lg:mb-8 max-w-[36rem]"
          />
          <div className="flex gap-10 max-md:flex-col">
            ...
            <div className="flex flex-col">
              ...
              <div className="relative">
                <img
                  src={data.image_url} // Placeholder for CEO image
                  alt="CEO Image"
              ...
              <div className="flex flex-col gap-6">
                ...
                <p
                  ...
                  dangerouslySetInnerHTML={{
                    __html: convertNewlinesToHTML(data.message),
                  }}
                ></p>
                )}
                ...
                <div className="flex flex-col gap-3">
                  <div className="space-y-1.5">
                    <TitleSmall label={data.name} el="h4" />
                    <TextHuge
                      label={data.role}
                      el="p"
                      cls="text-[#767676] font-light"
                    />
                  </div>
