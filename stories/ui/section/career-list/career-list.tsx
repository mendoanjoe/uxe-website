      ...
      <div className="max-w-[1440px] mx-auto flex flex-col gap-10 min-h-screen">
        <div className="p-[max(32px,_min(calc(100vw_*_(80_/_1440)),_80px))_max(20px,_min(calc(100vw_*_(178_/_1440)),_178px))] max-xl:px-[max(20px,_min(calc(100vw_*_(70_/_1440)),_70px))] flex flex-col">
          ...
          <div className="flex justify-between items-end max-md:flex-col max-md:items-start max-md:gap-8 max-sm:gap-6">
            ...
            {/* <div className="flex max-sm:flex-wrap gap-3 max-md:w-full max-md:gap-2 max-md:hidden">
          ...
          <div className="grid grid-cols-[.7fr_1fr] max-lg:grid-cols-2 max-md:flex max-md:flex-col max-md:gap-8 gap-[10%]">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="hidden max-sm:flex-wrap gap-3 max-md:w-full max-md:gap-2 max-md:flex">
                <div className="w-full min-w-40">
                  <div className="relative">
                    <select title="Department"
                    className="w-full bg-transparent pl-4 pr-8 py-3 max-md:py-2 transition duration-300 border border-[#D9D9D9] rounded-[100px] ease focus:outline-none appearance-none cursor-pointer"
                      ...
                      <div className="flex gap-2 items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                          <g clipPath="url(#clip0_440_9144)">
                            <path d="M10.0003 5.0013V10.0013L13.3337 11.668M18.3337 10.0013C18.3337 14.6037 14.6027 18.3346 10.0003 18.3346C5.39795 18.3346 1.66699 14.6037 1.66699 10.0013C1.66699 5.39893 5.39795 1.66797 10.0003 1.66797C14.6027 1.66797 18.3337 5.39893 18.3337 10.0013Z" stroke="#19191B" strokeOpacity="0.5" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
                          </g>
                          <defs>
