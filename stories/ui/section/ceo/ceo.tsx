...
import { getCeoMessageOption } from "lib/api";
...
export const CEOMsgSection = ({ text, custom }) => {
  ...
  const [ceoMessageData, setCeoMessageData] = useState<CeoMessageData>(null);
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const data = await getCeoMessageOption(); 
        const ceoMessage: CeoMessageData = {
            ...
            <div className="flex gap-10 max-md:flex-col">
              ...
              <div className="flex flex-col">
                ...
                <div className="relative">
                  <img
                    src={ceoMessageData.image_url} // Placeholder for CEO image
                    alt="CEO Image"
                  ...
                  {isClient && (
                    <p
                      ...
                      dangerouslySetInnerHTML={{
                        __html: convertNewlinesToHTML(ceoMessageData.message)
                      }}
                    ></p>
                  )}
