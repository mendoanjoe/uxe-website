              ...
              <div key={index} className="flex flex-col gap-6 max-md:gap-4 md:flex-row bg-[#F7F7F7] p-6 max-md:p-4 rounded-xl overflow-hidden">
                ...
                <div className='flex justify-between w-full'>
                  ...
                  <div className='flex-1 flex flex-col justify-between max-w-md py-5 max-md:py-0 max-md:gap-2'>
                    <TitleSmall label={post.title} el='a' href={"/article/" + post.slug} cls='line-clamp-2' />
                    <div>
                  ...
                  {/* Read Post Button */}
                  <a href={"/article/" + post.slug} className="text-[max(14px,_min(calc(100vw_*_(16_/_1440)),_16px))] font-medium leading-[132%] -tracking-[.16px] mt-auto flex gap-1">
                    Read post
                    <span>
